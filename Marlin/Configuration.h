...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 498.61
  #define DEFAULT_bedKi 93.58
  #define DEFAULT_bedKd 1771.93
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 405 } // Stock Creality
...
#define Y_BED_SIZE 470 // Nozzle is at Y2 when homed

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -20 // used to be -33, so 2 mm shift to left now
#define Y_MIN_POS -20 // used to be -10, so 2 mm shift to the back
#define Z_MIN_POS 0
